...
| `csi.attacher.tag` | Attacher image tag | `"v4.9.0"` |
...
| `csi.provisioner.tag` | Provisioner image tag | `"v5.3.0"` |
...
| `csi.snapshotter.tag` | Snapshotter image tag | `"v8.3.0"` |
